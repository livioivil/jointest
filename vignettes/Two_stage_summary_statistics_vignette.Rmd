...
p=ggplot(oasis, aes(x = Age, y = nWBV, colour = Group, group = Subject.ID)) + geom_line() + geom_point()
p + theme_bw()
...
REMARK: Note that **Model failed to converge with max|grad| = 0.640671 (tol = 0.002, component 1)**
